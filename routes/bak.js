...
module.exports = function (app, conn) {
  ...
  app.post('/upload_table', function (req, res) {
    ...
    let first_table_field_data = req.body.first_table_field_data.replace(
      /(\s*)/g,
      ''
    );
    let first_table_field_data_type = req.body.first_table_field_data_type.replace(
      /(\s*)/g,
      ''
    );
